...
***********************************************************************/
static int fts_ft5472_upgrade(struct i2c_client *client, u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    if (ECC_CHECK_MODE_CRC16 == upgrade_func_ft5472.ecc_check_mode) {
...
struct upgrade_func upgrade_func_ft5472 = {
    ...
    .fwcfgoff = 0xFF00,
    .appoff = 0x0000,
    .ecc_check_mode = ECC_CHECK_MODE_CRC16,
