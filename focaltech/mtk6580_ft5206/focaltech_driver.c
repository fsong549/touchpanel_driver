...
struct Upgrade_Info fts_updateinfo[] =
{
    ...
    //{0x00,"FT6x36",TPD_MAX_POINTS_2,AUTO_CLB_NONEED,100, 30, 0x79, 0x18, 10, 2000},//CHIP ID error
	...
	{0x00,"FT5x16",TPD_MAX_POINTS_5,AUTO_CLB_NEED,50, 30, 0x79, 0x07, 1, 1500}, /* 5316Éý¼¶Ê§°Üºó»Ö¸´*/
...
static void check_gesture(int gesture_id)
{
	...
	printk("FTS check_gesture, gesture_id = %d", gesture_id);
...
*/	
	...
	//if ((fts_updateinfo_curr.CHIP_ID!=0x0A))
