...
int fts_ctpm_auto_clb(struct i2c_client *client)
{
	...
	msleep(300);
	if ((fts_updateinfo_curr.CHIP_ID==0x0a)||(fts_updateinfo_curr.CHIP_ID==0x00) ||(fts_updateinfo_curr.CHIP_ID==0x12) ||(fts_updateinfo_curr.CHIP_ID==0x13) ||(fts_updateinfo_curr.CHIP_ID==0x14)) //5x36,5x36i
	{
		for(i=0;i<100;i++)
		{
...
static unsigned char CTPM_FW[] = {
	#include "5316_720X1480_ID22_Va2_20190301_app.i"
};
...
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	*/
	...
	else if ((fts_updateinfo_curr.CHIP_ID==0x0a)||(fts_updateinfo_curr.CHIP_ID==0x00))
    {
...
u8 fts_ctpm_get_i_file_ver(void)
{
	...
	if (ui_sz > 2)
	{
	    if((fts_updateinfo_curr.CHIP_ID==0x36))//||(fts_updateinfo_curr.CHIP_ID==0x00))
				       ...
				       char *firmware_name)
{
	...
	else if ((fts_updateinfo_curr.CHIP_ID==0x0a))
	{
