...
#define TPD_KEYS                { KEY_APP_SWITCH, KEY_F10, KEY_BACK}
#define TPD_KEYS_DIM_QHD            	{{90,1500,120,TPD_BUTTON_HEIGH},{250,1500,120,TPD_BUTTON_HEIGH},{450,1500,120,TPD_BUTTON_HEIGH}}
#define TPD_KEYS_DIM_FWVGA            	{{90,1500,120,TPD_BUTTON_HEIGH},{250,1500,120,TPD_BUTTON_HEIGH},{450,1500,120,TPD_BUTTON_HEIGH}}
/*********************Custom Define end*************************************************/
...
#define TPD_AUTO_UPGRADE				// if need upgrade CTP FW when POWER ON,pls enable this MACRO  HD
#endif
