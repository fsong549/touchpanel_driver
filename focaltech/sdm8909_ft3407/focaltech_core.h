...
#define FTS_GESTRUE_EN 1//0  suhongzhu open gesture function
#define GTP_ESD_PROTECT 0
#define FTS_APK_DEBUG 1//none suhongzhu add
#define FTS_SYSFS_DEBUG 1//none suhongzhu add
#define FTS_CTL_IIC 1//none suhongzhu add
