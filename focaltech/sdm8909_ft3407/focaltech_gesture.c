...
#define  KEY_GESTURE_C		KEY_C/*suhongzhu@uniscope 20161031 add gesture C*/
...
#define GESTURE_C		    0x34/*suhongzhu@uniscope 20161031 add gesture C*/
...
int fts_Gesture_init(struct input_dev *input_dev)
{
	...
	input_set_capability(input_dev, EV_KEY, KEY_GESTURE_C);/*suhongzhu@uniscope 20161031 add gesture C*/ 
	...
	__set_bit(KEY_GESTURE_C, input_dev->keybit);/*suhongzhu@uniscope 20161031 add gesture C*/
...
static void fts_check_gesture(struct input_dev *input_dev,int gesture_id)
{
	switch(gesture_id)
	{
	        ...
	        case GESTURE_E:
	                ...
	                input_sync(input_dev);
	                break;
		/*suhongzhu@uniscope 20161031 add gesture c begin*/
	        case GESTURE_C:
	                ...
	                input_sync(input_dev);
	                break;
		/*suhongzhu@uniscope 20161031 add gesture c end*/
	        case GESTURE_L:
...
int fts_read_Gestruedata(void)
{
	...
	else
	{
		...
		gestrue_id = fetch_object_sample(buf, pointnum);//zhangbing add
		fts_check_gesture(fts_input_dev,gestrue_id);
		printk( "%d kaka read gestrue_id.\n", gestrue_id);
		//pr_err("*****Enter::::::::::suhongzhu:::::::::gestrue_id=%d\n",gestrue_id);/suhongzhu add
