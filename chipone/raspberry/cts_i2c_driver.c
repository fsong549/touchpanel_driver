...
//static ssize_t i2c_xfer_size_show(struct device_driver *dev, char *buf)
static ssize_t i2c_xfer_size_show(struct device *dev,struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "CFG_CTS_MAX_I2C_XFER_SIZE: %d\n",
			CFG_CTS_MAX_I2C_XFER_SIZE);
}
//static DRIVER_ATTR_RO(i2c_xfer_size, S_IRUGO, i2c_xfer_size_show, NULL);
static struct device_attribute i2c_xfer_size_show = __ATTR(size_show,0664,i2c_xfer_size_show,NULL);
