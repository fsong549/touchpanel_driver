...
{
#include "F6_TDT_Bailifeng_CID070A_D00_C06_20180622.h"
};
#endif
...
static void himax_report_points(struct himax_ts_data *ts)
{
    ...
    if (hx_point_num != 0 )
    {
        ...
        for (loop_i = 0; loop_i < ts->nFinger_support; loop_i++)
        {
			...
			//ble modify just for temp for cta, after must return back and chage fw
            //must restore
...
#ifdef HX_SMART_WAKEUP
	ts->SMWP_enable = himax_gesture_enable_hx83103;
    if(ts->SMWP_enable)
    {
