 ...
 *
 * $Revision: 16487 $
 * $Date: 2017-09-14 10:28:16 +0800 (÷‹Àƒ, 14 æ≈‘¬ 2017) $
 *
...
info_retry:
	...
	if ((buf[1] + buf[2]) != 0xFF) {
		...
		snprintf(xc_tp_info, sizeof(xc_tp_info),"ChipId:%s;FwverVer:0x%02X;I2cAddr:0x%02X\n",NVT_TS_NAME,buf[1],I2C_HW_Address);
		ret = 0;
	}
